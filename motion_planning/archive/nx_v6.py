...
class RRT:
    ...
    def nearest_neighbor(self, x_rand, rrt):
        ...
        for v in rrt.vertices:
            ...
            """ 
            if np.linalg.norm(RRT.x_goal - np.array(v[:2])) < 1.0:
                print("Found Goal")    
                sys.exit('Found Goal')
            """
    ...
    def generate_RRT(self, grid, x_init, num_vertices, dt, rrt_path):
...
class MotionPlanning(Drone):
    ...
    def plan_path(self):
        ...
        """ rrt = RRT.generate_RRT(self, grid, RRT.x_init, RRT.num_vertices, RRT.dt, RRT.)
    ...
    def Goal_Path(self, grid):       
        print ("Goal Found.")
        #rrt_path = RRT.generate_RRT #nx.DiGraph()
